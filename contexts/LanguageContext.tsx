...
const TRANSLATIONS: Record<string, Record<string, string>> = {
  fr: {
    ...
    'dash.view': 'Voir',
    'dash.stats_title': 'Mes Statistiques',
    'dash.success_rate': 'Taux de Réussite',
    'dash.total_points': 'Points Totaux',
    'dash.historical_rank': 'Classement Général',
  ...
  en: {
    ...
    'dash.rank': 'Rank',
    'dash.view': 'View',
    'dash.stats_title': 'My Statistics',
    'dash.success_rate': 'Success Rate',
    'dash.total_points': 'Total Points',
    'dash.historical_rank': 'Overall Rank',
  ...
  es: {
    ...
    'dash.rank': 'Rango',
    'dash.view': 'Ver',
    'dash.stats_title': 'Mis Estadísticas',
    'dash.success_rate': 'Tasa de Éxito',
    'dash.total_points': 'Puntos Totales',
    'dash.historical_rank': 'Clasificación General',
  },
  pt: {
    ...
    'dash.rank': 'Ranking',
    'dash.view': 'Ver',
    'dash.stats_title': 'Minhas Estatísticas',
    'dash.success_rate': 'Taxa de Sucesso',
    'dash.total_points': 'Pontos Totais',
    'dash.historical_rank': 'Classificação Geral',
  },
  ar: {
    ...
    'dash.rank': 'مرتبة',
    'dash.view': 'عرض',
    'dash.stats_title': 'إحصائياتي',
    'dash.success_rate': 'نسبة النجاح',
    'dash.total_points': 'إجمالي النقاط',
    'dash.historical_rank': 'الترتيب العام',
  }
};
